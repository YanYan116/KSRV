...
RNA = scv.read('KSRV Datasets/Mouse_brain/RNA_adata.h5ad')
HybISS = scv.read('KSRV Datasets/Mouse_brain/HybISS_adata.h5ad')
...
HybISS_imputed = KSRV(HybISS,RNA,50,['Region','Subclass'],method = 'kernelpca')
